...
HD_PWD='C:/Users/Apple/Desktop/vivado/timer/timer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tim_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tim_test.tcl
