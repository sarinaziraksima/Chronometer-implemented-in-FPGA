...
HD_PWD='C:/Users/Apple/Desktop/vivado/timer/timer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tim_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tim_test.tcl -notrace
